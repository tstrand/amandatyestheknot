    ...
    $(window).load(function () {
       $("#myCarousel").carousel('pause');
        var events = [["Jovens", "2005", "img/events/8th-grade.jpg", "Amanda e Tyler se conheceram, na escola Horace Mann, em 2005, onde ambos cursavam a 7a série do ensino fundamental. Amanda, como aluna nova, chamou logo a atenção do Tyler  que rapidamente interessou-se em mostrar-lhe tudo à volta."],
                        ["Namorados", "2008", "img/events/highschool.jpg", "Após três anos de cortejo, Amanda aceitou o convite de Tyler para se encontrarem no Zoológico do Central Park em Março de 2008. E assim uma linda história de amor tem início..."],
                        ["Término do Ensino Médio. Destino: Califórnia", "2010", "img/events/hm-grad.jpg", "Ao terminarem o ensino médio, na escola Horace Mann, Amanda 17 e Tyler 18, ingressaram na Universidade Stanford na Califórnia. Feliz coincidência! Assim sendo, para felicidade de ambos, suas vidas vão sendo cada vez mais entrelaçadas."],
